...
🎮 **GVRM for Unreal Engine 5** is now in development!

Bring photorealistic animated Gaussian Splatting avatars to your UE5 projects.

**Status:** 🚧 Prototype Phase

**Features (Planned):**
- Real-time Gaussian Splatting rendering in UE5
- VRM skeletal animation support (via VRM4U)
- Niagara-based particle system integration
- Same GVRM file format compatibility

**Quick Start:**
```bash
# Convert GVRM file for UE5
cd ue5/Tools
python gvrm_to_ue5.py ../../assets/author.gvrm -o ./output
```

**Learn More:** See `ue5/README.md` for implementation details and development roadmap.
